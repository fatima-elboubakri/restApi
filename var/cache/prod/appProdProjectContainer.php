...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('npvlFaJ9wc', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RLf95HR82Y', 0, 'WtbaGZKFWfQxsKYuG3m8Mj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'recrute', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\CandidatBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\DocumentBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'CandidatBundle\\Entity');
        $c->addDriver($b, 'DocumentBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('CandidatBundle' => 'CandidatBundle\\Entity', 'DocumentBundle' => 'DocumentBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_f265433986f506fbe8c9e16236bbac58894f8425ea0dcbc201abf886709731ef');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CandidatBundle/Resources/views'), 'Candidat');
        $instance->addPath(($this->targetDirs[3].'\\src\\DocumentBundle/Resources/views'), 'Document');
        $instance->addPath(($this->targetDirs[3].'\\src\\RechercheBundle/Resources/views'), 'Recherche');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fa2708e14ab0a7f6f8f4c4879986537342cb9d13');
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LJ-YsFQ1FF', 0, 'WtbaGZKFWfQxsKYuG3m8Mj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VTxMgfHwwv', 0, 'WtbaGZKFWfQxsKYuG3m8Mj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5abc1f21e65912.38875883')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CandidatBundle' => 'CandidatBundle\\CandidatBundle',
                'DocumentBundle' => 'DocumentBundle\\DocumentBundle',
                'RechercheBundle' => 'RechercheBundle\\RechercheBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'CandidatBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CandidatBundle'),
                    'namespace' => 'CandidatBundle',
                ),
                'DocumentBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\DocumentBundle'),
                    'namespace' => 'DocumentBundle',
                ),
                'RechercheBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RechercheBundle'),
                    'namespace' => 'RechercheBundle',
                ),
                'UserBundle' => array(
                    'parent' => NULL,
            ...
            'secret' => 'fa2708e14ab0a7f6f8f4c4879986537342cb9d13',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'fa2708e14ab0a7f6f8f4c4879986537342cb9d13',
            ...
            'validator.mapping.cache.prefix' => 'validator_a72d48e510bce039925a1652e6708edcc84f1ea8534b9c99b60341468a7ecd67',
